...
class GiftedChat extends React.Component {
    ...
    static getDerivedStatsFromProps(nextProps = {}, prevState) {
        console.log('Sailee check Data', nextProps);
        
        return {};
    }
    shouldComponentUpdate(nextProps = {}, nextState) {
        console.log('Sailee check Data2', nextState);
        const { messages, text } = nextProps;
        messagess = messages || [];
        if (text !== undefined && text !== prevState.text) {
            this.setState({ text });
        }
        return true;
    }
